    ...
    <form action="{{ route('experience.update', $data->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm @error('judul') is-invalid @enderror " name="judul"
                id="judul" aria-describedby="helpId" placeholder="Judul Proyek" value="{{ $data->judul }}" autofocus>
            @error('judul')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm @error('info1') is-invalid @enderror" name="info1"
                id="info1" aria-describedby="helpId" placeholder="Bahasa atau Framework yang digunakan"
                value="{{ $data->info1 }}">
            @error('info1')
                <div class="invalid-feedback">
                    {{ $message }}
        ...
        {{-- <div class="mb-3">
            <div class="row">
                ...
                <div class="col-auto"><input type="date"
                        ...
                        id="tgl_mulai" placeholder="dd/mm/yy" value="{{ $data->tgl_mulai }}">
                    @error('tgl_mulai')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-auto"><input type="date" class="form-control form-control-sm" name="tgl_akhir"
                        id="tgl_akhir" placeholder="dd/mm/yy" value="{{ $data->tgl_akhir }}"></div>
            </div>
        </div> --}}
        <div class="mb-3">
